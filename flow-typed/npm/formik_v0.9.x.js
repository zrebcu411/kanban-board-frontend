// flow-typed signature: 98eef76ba100b25b40b64e8e884e7e7f
// flow-typed version: f5d9e2665f/formik_v0.9.x/flow_>=v0.53.x
...
declare module 'formik' {
  ...
  declare export type FieldProps<V> = {
    field: {
      /** Classic React change handler, keyed by input name */
      // TODO: React.ChangeEvent<any>
      onChange: (e: any) => any,
  ...
  declare export function getIn<Values>(any, $Keys<Values>): any;
}
